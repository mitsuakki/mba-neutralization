...
@.str = private unnamed_addr global [14 x i8] c"\0C4=?313?49.9\\\\", align 1
...
@.str.1 = private unnamed_addr global [32 x i8] c"Rtf`b='\22t';tsuni`9';ob\7FXqfkrb9\0D\07", align 1
@str = private unnamed_addr global [29 x i8] c"\9A\A7\A7\BC\8E\BD\A6\AB\BC\A1\A7\A6\E8\BA\AD\BC\BD\BA\A6\AD\AC\E8\AE\A9\A4\BB\AD\E6\C8", align 1
@str.4 = private unnamed_addr global [28 x i8] c"PmmvDwlavkml\22pgvwplgf\22vpwg,\02", align 1
@llvm.global_ctors = appending global [4 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 0, ptr @decrypt.arr.0, ptr null }, { i32, ptr, ptr } { i32 0, ptr @decrypt.arr.1, ptr null }, { i32, ptr, ptr } { i32 0, ptr @decrypt.arr.2, ptr null }, { i32, ptr, ptr } { i32 0, ptr @decrypt.arr.3, ptr null }]
...
for.body:                                         ; preds = %for.cond
  %3 = getelementptr [14 x i8], ptr @.str, i32 0, i32 %1
...
define private void @decrypt.arr.1() {
head:
  %0 = alloca i32, align 4
  store i32 0, ptr %0, align 4
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  %3 = getelementptr [32 x i8], ptr @.str.1, i32 0, i32 %1
  %4 = load i8, ptr %3, align 1
  %5 = xor i8 %4, 7
  store i8 %5, ptr %3, align 1
  br label %for.inc
...
define private void @decrypt.arr.2() {
head:
  %0 = alloca i32, align 4
  store i32 0, ptr %0, align 4
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  %3 = getelementptr [29 x i8], ptr @str, i32 0, i32 %1
  %4 = load i8, ptr %3, align 1
  %5 = xor i8 %4, -56
  store i8 %5, ptr %3, align 1
  br label %for.inc
...
define private void @decrypt.arr.3() {
head:
  %0 = alloca i32, align 4
  store i32 0, ptr %0, align 4
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  %3 = getelementptr [28 x i8], ptr @str.4, i32 0, i32 %1
  %4 = load i8, ptr %3, align 1
  %5 = xor i8 %4, 2
  store i8 %5, ptr %3, align 1
  br label %for.inc
